...
def train_process():
    ...
    generate_filename_soh_pair(config.bat_names,
                                config.base_path+'../data/subset_image_files_oct12_20cycles/file_soh_multi_input.csv')
    generate_filename_soh_pair(config.test_bat_names,
                                config.base_path+'../data/subset_image_files_oct12_20cycles/test_file_soh_multi_input.csv')

    train_data = CustomDataset(config.base_path+'../data/subset_image_files_oct12_20cycles/file_soh_multi_input.csv', config.transform)
    test_data = CustomDataset(config.base_path+'../data/subset_image_files_oct12_20cycles/test_file_soh_multi_input.csv', config.transform)
